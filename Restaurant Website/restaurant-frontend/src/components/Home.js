    ...
    return (
        <>
                ...
                <Container>
                    <AnimatedBox sx={{ textAlign: 'center', mb: 6 }}>
                        ...
                        <Typography variant="body1" sx={{ maxWidth: '800px', margin: '16px auto', fontFamily: 'Georgia, serif', color: '#FFEB3B' }}>
                            TAJ Restaurant was founded in 1980 with the goal of bringing authentic flavors to our community. Our chefs use only the freshest ingredients to create dishes that celebrate tradition and innovation.
                        </Typography>
                    </AnimatedBox>
                            ...
                            <Grid item xs={12} sm={6} md={4}>
                                <SlidePaper elevation={5} trigger={trigger}>
                                    ...
                                    <Box className="content" sx={{ p: 2 }}>
                                        ...
                                        <Typography variant="subtitle1">- Afiya Sainu</Typography>
                                    </Box>
                                </SlidePaper>
                            </Grid>
                            <Grid item xs={12} sm={6} md={4}>
                                <SlidePaper elevation={5} trigger={trigger}>
                                    ...
                                    <Box className="content" sx={{ p: 2 }}>
                                        ...
                                        <Typography variant="subtitle1">- Jennathul Firdous</Typography>
                                    </Box>
                                </SlidePaper>
                            </Grid>
                        </Grid>
                            ...
                            <ScrollTrigger onEnter={() => setTrigger1(true)} onExit={() => setTrigger1(false)}>
                                <Paper elevation={6} sx={{ p: 4, textAlign: 'center', backgroundImage: 'linear-gradient(145deg, #555, #333)', borderRadius: '12px', animation: trigger1 ? `${moveFromBottomToTop} 1s ease-out` : 'none', color: '#FFEB3B' }}>
                                    <Typography variant="h6" gutterBottom sx={{ fontFamily: 'Cinzel, serif', fontWeight: 'bold' }}>
                                        Special Biriyani - September 25th
                                    </Typography>
                                    <Typography variant="body1">Join us for an exclusive Biriyani tasting event featuring selections from around the world.</Typography>
                                </Paper>
                            </ScrollTrigger>
                        </Grid>
                        <Grid item xs={12} md={6}>
            ...
            <Box sx={{ py: 4, backgroundColor: '#111', color: 'white', textAlign: 'center' }}>
                <Container>
                    <Typography variant="body2">© 2024 Taj hotel. All Rights Reserved.</Typography>
                </Container>
            </Box>
        </>
    );
